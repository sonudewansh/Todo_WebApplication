<script>
  ...
  const handleAddTodoBtn = async() => {
      fetch("https://mytodo-git-master-sonudewanshs-projects.vercel.app/api/add-todo", {
          method:"POST",
          body:JSON.stringify({
  ...
  //Fetching get-todo
  const getTodo = () => {
  fetch("https://mytodo-git-master-sonudewanshs-projects.vercel.app/api/get-todo")
    .then((res) => res.json())
    .then((data) => {
  ...
  fetch("https://mytodo-git-master-sonudewanshs-projects.vercel.app/api/delete-todo", {
    method: "POST",
    body: JSON.stringify({
      id: id,
    }),
  ...
  fetch("https://mytodo-git-master-sonudewanshs-projects.vercel.app/api/edit-todo", {
    method: "POST",
    body: JSON.stringify({
      id: editTodoId,
      title: title,
